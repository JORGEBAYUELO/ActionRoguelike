...
ASExplosiveBarrel::ASExplosiveBarrel()
{
	...
	ForceComp->ImpulseStrength = 2500.0f; // Alternative: 200000.0 if bImpulseVelChange = flase
	//Optional, igonores 'Mass' of other objects (if false, the impulse strength will be much higher to push most objects depending on Mass)
